...
const msg = {
rowner: '「👑」 *Esta función solo puede  usada por mi creador*\n\n> Legendary.', 
owner: '「🐉」 *Esta función solo puede  usada por mi desarrollador.', 
mods: '「🐉」 *Esta función solo puede  usada por mis desarrolladores.*', 
premium: '「☁️」 *Esta función solo es para usuarios Premium.', 
group: '「🐲」 *Esta funcion solo puede  ejecutada en grupos.*', 
private: '「💨」 *Esta función solo puede  usada en chat privado.*', 
admin: '「⚜️」 *Este comando solo puede  usado por admins.*', 
botAdmin: '「⚜️」 *Para usar esta función debo  admin.*', 
